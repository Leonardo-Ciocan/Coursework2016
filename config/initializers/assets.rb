...
Rails.application.config.assets.precompile += %w( vs.css )
...
Rails.application.config.assets.precompile += %w( markdown-it.js )
Rails.application.config.assets.precompile += %w( sheet_manager.js )
Rails.application.config.assets.precompile += %w( chromath.min.js )